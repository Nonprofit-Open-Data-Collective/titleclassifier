...
write.csv( x=as.data.frame(df), file="PACKAGE-DEMO.csv", row.names=F )
```
...
df[ c("TITLE_RAW","TitleTxt2","TitleTxt3") ]
```
...
df[ c("F9_07_COMP_DTK_NAME_PERS","Num.Title","TITLE_RAW","TitleTxt3","TitleTxt4") ] %>% 
...
VICE PRESIDENT MEMBERSHIP --> VICE PRESIDENT OF MEMBERSHPIP? 
VICE PRESIDENT VOLUNTEERS --> VICE PRESIDENT OF VOLUNTEERS?
...
keep <- 
  c("Num.Title", "TITLE_RAW", "TitleTxt6", 
    "date.x", "SCHED.O", "SCHED.AT.LARGE", 
    "AS.NEEDED", "EX.OFFICIO", "CO",  
    "REGIONAL",  "FUTURE", "FORMER", "INTERIM" )
