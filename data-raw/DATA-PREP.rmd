...
Titles are often accompanied by some adjective describing a **temporary or temporal period** in which the person holds the title (*former, future, interim, etc.*). For example, the **former.word** objects are used to create the "former" flag to designate that an individual is a former or outgoing status in her/his position:
