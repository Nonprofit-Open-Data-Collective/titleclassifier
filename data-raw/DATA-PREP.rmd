...
The following dictionary objects were created to assist with cleaning raw title strings: 
...
* [likely.subjects](https://raw.githubusercontent.com/Nonprofit-Open-Data-Collective/titleclassifier/main/data-raw/likely-subjects.R)
* [likely.titles](https://raw.githubusercontent.com/Nonprofit-Open-Data-Collective/titleclassifier/main/data-raw/likely-titles.R)
* [possible.titles](https://raw.githubusercontent.com/Nonprofit-Open-Data-Collective/titleclassifier/main/data-raw/possible-titles.R)                    
...
Titles are often accompanied by some adjective describing a temporary or temporal period in which the person holds the title. These phrases are removed from the titles and flags are created for each. Note that status here describes time, not hierarchy. 

These lists are primarily used in [gen_status_codes()](https://github.com/Nonprofit-Open-Data-Collective/titleclassifier/blob/main/R/06-gen-status-codes.R):
...
<a href="https://docs.google.com/spreadsheets/d/1iYEY2HYDZTV0uvu35UuwdgAUQNKXSyab260pPPutP1M/edit#gid=145854139" class="button"> STATUS DICTIONARY </a>
...
- raw.titles: character vector of 1,000 titles
- tinypartvii: data frame with all DTK members of 10,000 nonprofits 
...
```{r}
possible.titles <- 
c("VICE PRESIDENT", "DIRECTOR", "CHAIR", "DEAN", "TRUSTEE", "CEO", "SECRETARY",
  "MANAGER","MEMBER"        
)
```
...
<a href="https://docs.google.com/spreadsheets/d/1iYEY2HYDZTV0uvu35UuwdgAUQNKXSyab260pPPutP1M/edit#gid=1464446536" class="button"> SPREADSHEET </a>
...
```{r}
write.csv( df.standard, "google-sheets-backup/title-standard-v.csv" )
...
```{r}
c("\\bINTERIM\\b", "\\bINT\\b", "\\bACTING\\b", "\\bTEMPORARY\\b", 
"\\bTEMP\\b")
```
