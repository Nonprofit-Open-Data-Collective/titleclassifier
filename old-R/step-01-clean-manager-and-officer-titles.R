...
## ------------------------------------------------------------------------
# old dataset
dat <- readRDS( "data-raw/p7a_data.rds" )
head( dat ) %>% pander


# new version
# d2 <- readRDS( "data-raw/FULL-PART-VII-TABLE-01.rds" )
d1 <- readRDS( "data-raw/2016-PART-VII-TABLE-01.rds" )
head( d1 )
...
## ---- eval=F-------------------------------------------------------------
## 
## d2 <- filter( d2, totalComp > 1  &  AvgHrs > 20 )
## 
...
d2$TitleTxt2[grepl( " EX DIRECTOR ", d2$TitleTxt2 ) & 
               d2$Officer == 1 & d2$FmrOfficer == 0] <- gsub(" EX DIRECTOR ", " EXECUTIVE DIRECTOR ", d2$TitleTxt2)[grepl( " EX DIRECTOR ", d2$TitleTxt2 ) & d2$Officer == 1 & d2$FmrOfficer == 0]
...
#' 
## ------------------------------------------------------------------------
saveRDS( d2, "cleaned-titles/cleaned-titles-2016.rds")
...
print( paste( "TOTAL RUN TIME: ", end.time - start.time ) )
