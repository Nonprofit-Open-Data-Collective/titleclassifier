...
#' 
## ------------------------------------------------------------------------
d2 <- readRDS( "cleaned-titles/cleaned-titles-2016.rds")
...
#' 
## ------------------------------------------------------------------------
Title.Categorized <- load("title-categories/title-list.rdata")
All.Titles %>% names()
...
#' 
## ------------------------------------------------------------------------
saveRDS( d2, "cleaned-titles/categorized-titles.rds")
